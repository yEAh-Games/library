---
layout: post
title: Daily report for RG-YGSE﹕31/03/2022
date: 2022-04-03 19:34
author: yeahgamesdevs
comments: true
categories: [Daily reports, Finance, investing, news, reports, rg, RG-YGSE, Stocks]
image: /archive/img/reports/daily/rg/31-03-2022.png
link: https://yankarchive.yeahgames.net/stocks/reports/daily/rg/2022/03/31
c: Yank
redirect_from:
  - /item/daily-report-for-31-03-2022-rgygse
canonical_url: https://yankarchive.yeahgames.net/stocks/reports/daily/rg/2022/03/31
---
<!-- wp:paragraph -->
<p>This is the daily report for <code>Random Guy TCG</code> <code>(RG:YGSE)</code> on the yEAh Games Stock Exchange (YGSE), on <code>Thursday, the 31st of March, 2022</code>.<br><em>Full stock history for this company can be viewed here.</em></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>— BOTS:YGSE has been released. See its report below. <br>— You may want to look at annoucements because there are some changes that may affect stock prices. — Weekly close is only at 0 because the price <em>was</em> 0 on Sunday. <br>— Dividends have been released. Check your accounts!</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-large"><img src="https://yeaharchives.files.wordpress.com/2022/04/image-9.png?w=540" alt="" class="wp-image-141" /></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-large"><img src="https://yeaharchives.files.wordpress.com/2022/04/image-10.png?w=600" alt="" class="wp-image-142" /></figure>
<!-- /wp:image -->
